package com.squirrel.websocket.stomp.rest;
...
public class StompConstroller  {
    ...
    public void mockPublicNews(){
        ...
        while (true) {
            ...
            template.convertAndSend("/topic/public_news",JSONObject.toJSONString(list));
        }
    ...
    private int randomInt(){
        return RandomUtils.nextInt(100,10000);
    }
